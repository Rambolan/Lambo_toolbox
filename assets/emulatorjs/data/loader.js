(async function() {
    ...
    // 优先加载完整压缩版 emulator.min.js
    const minifiedLoaded = await loadScript(scriptPath + "emulator.min.js");
    if (!minifiedLoaded) {
        console.warn("emulator.min.js 加载失败，回退到非压缩文件");
        await filesmissing("emulator.min.js");
    }
